...
class ContentCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.admin.contentCategories.index', compact('contentCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.admin.contentCategories.create');
    }
    ...
    public function edit(ContentCategory $contentCategory)
    {
        ...
        return view('dashboard.admin.contentCategories.edit', compact('contentCategory'));
    }
    ...
    public function show(ContentCategory $contentCategory)
    {
        ...
        return view('dashboard.admin.contentCategories.show', compact('contentCategory'));
    }
