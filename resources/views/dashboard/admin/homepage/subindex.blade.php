    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success"  data-toggle="modal" data-target="#add_page" style="color: white">
                {{ trans('global.add') }} HomePage Content of {{ strip_tags($Homepage->title) }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ strip_tags($Homepage->title) }} Content {{ trans('global.list') }}
    </div>
                            ...
                            <div class="modal-dialog" role="document" style="max-width:60%">
                                <div class="modal-content">
                                    ...
                                    <form  method="POST" action="{{ route('admin.homepage.update', $homepage->id) }}" enctype="multipart/form-data">
                                        ...
                                        @method('PUT')
                                        <input type="hidden" name="parent_id" value="{{ old('parent_id',  $homepage->parent_id) }}">
                                        <div class="row">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                               <form  method="POST" action="{{ route('admin.homepage.store') }}" enctype="multipart/form-data">
                                   @csrf 
                                   <input type="hidden" name="last_url" value="{{  URL::current() }}">
                                <input type="hidden" name="parent_id" value="{{ old('parent_id',  $Homepage->id) }}">
                                 <div class="row">
                                    <div class="form-group col-12">
                                        <label for="title">Title</label>
