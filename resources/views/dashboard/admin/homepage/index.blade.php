                    ...
                    <tbody>
                            ...
                            <div class="modal-dialog" role="document" style="max-width:60%">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">&emsp;Home page Meta Content Edit
                                        </h5>
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="{{ route('admin.homepage.update', $logo->id) }}"
                        ...
                        <tr data-entry-id="{{ $metadata->id ?? '' }}">
                            ...
                            <td>
                                ...
                                @can('menu_edit')
                                    <a class="btn btn-xs btn-info" style="color: white" data-toggle="modal"
                                        data-target="#add_page{{ $metadata->id }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
                        ...
                        <!-- Meta Update -->
                        <div class="modal fade" id="add_page{{ $metadata->id }}" role="dialog"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document" style="max-width:60%">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="{{ route('admin.homepage.update', $metadata->id) }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="last_url" value="{{ URL::current() }}">
                                            @method('PUT')
                                            <div class="row">
                                                <div class="form-group col-12">
                                                    ...
                                                    <textarea class="form-control" type="text" id="title" name="title" placeholder="Enter something...."
                                                        rows="2">{{ old('title', $metadata->title) }}</textarea>
                                                </div>
                                                <div class="form-group col-12">
                                                    <label for="blog">Meta Description</label>
                                                    <textarea class="form-control" type="text" id="content" name="content" placeholder="Enter something...."
                                                        rows="10">{{ old('content', $metadata->content) }}</textarea>
                                                </div>
                                            </div>
                        ...
                        <tr data-entry-id="{{ $footerdata->id ?? '' }}">
                            ...
                            <td>
                                ...
                                @can('menu_edit')
                                    <a class="btn btn-xs btn-info" style="color: white" data-toggle="modal"
                                        data-target="#add_page{{ $footerdata->id }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
                        ...
                        <!-- Footer Update -->
                        <div class="modal fade" id="add_page{{ $footerdata->id }}" role="dialog"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document" style="max-width:60%">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST"
                                            action="{{ route('admin.homepage.update', $footerdata->id) }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="last_url" value="{{ URL::current() }}">
                                            @method('PUT')
                                            <div class="row">
                                                <div class="form-group col-12">
                                                    ...
                                                    <textarea class="form-control ckeditor" type="text" id="title" name="title"
                                                        placeholder="Enter something...." rows="2">{{ old('title', $footerdata->title) }}</textarea>
                                                </div>
                                                <div class="form-group col-12">
                                                    <label for="blog">Footer Section 2</label>
                                                    <textarea class="form-control ckeditor" type="text" id="content" name="content"
                                                        placeholder="Enter something...." rows="10">{{ old('content', $footerdata->content) }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-12 mt-2">
                                                    ...
                                                    <textarea class="form-control ckeditor" type="text" name="alt" placeholder="Enter something...."
                                                        rows="10">{{ old('alt', $footerdata->alt) }}</textarea>
                                                </div>

                                                <div class="form-group col-12 mt-2">
                                                    <label for="title">Footer Section 4</label>
                                                    <textarea class="form-control ckeditor" type="text" name="image" placeholder="Enter something...."
                                                        rows="10">{{ old('image', $footerdata->image) }}</textarea>
                                                </div>
                                            </div>
                                            <button type="submit"
                                                class="btn btn-success btn-rounded btn-fw">Submit</button>
                    ...
                    <tbody id="sortable">
                        @foreach ($homepages as $key => $homepage)
                            <tr data-id="{{ $homepage->id }}">
                                ...
                                <td>
                                    <a href="{{ route('admin.homepage.sub', $homepage->id) }}">
                                        {{ strip_tags($homepage->title) ?? '' }} </a>
                                </td>
                                <td>
                                            ...
                                            <form method="POST"
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-12">
                                                        ...
                                                        <textarea class="form-control ckeditor" type="text" id="title" name="title"
                                                            placeholder="Enter something...." rows="2">{{ old('title', $homepage->title) }}</textarea>
                                                    </div>
                                                    <div class="form-group col-12">
                                                        <label for="blog">Content</label>
                                                        <textarea class="form-control ckeditor" type="text" id="content" name="content"
                                                            placeholder="Enter something...." rows="10">{{ old('content', $homepage->content) }}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-6 mt-2">
                                                        ...
                                                        <input class="form-control" type="color" name="bg_color"
                                                            value="{{ old('bg_color', $homepage->bg_color) }}">
                                                    </div>
                                                    <div class="form-group col-6 mt-2">
                                                        <label for="title">Bg Alt</label>
                                                        <input class="form-control" type="text" name="bg_alt"
                                                            value="{{ old('bg_alt', $homepage->bg_alt) }}">
                                                    </div>
                                                </div>
                                                <button type="submit"
                                                    class="btn btn-success btn-rounded btn-fw">Submit</button>
