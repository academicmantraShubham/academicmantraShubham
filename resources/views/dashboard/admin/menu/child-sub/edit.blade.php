                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text"
                                name="title" id="title" value="{{ old('title', $menu->title) }}" required>
                            @if ($errors->has('title'))
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('content') ? 'is-invalid' : '' }}"
                                ...
                                <option value="1" {{ old('content', $menu->content) == 1 ? 'selected' : '' }}>Yes
                                </option>
                                <option value="0" {{ old('content', $menu->content) == 0 ? 'selected' : '' }}>No
                                </option>
                            </select>
                ...
                <div id="content_data" style="display: none">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('ctitle') ? 'is-invalid' : '' }}" type="text"
                                    name="ctitle" id="ctitle" value="{{ old('ctitle', @$menu->post->title) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('meta_keyword') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('meta_keyword', @$menu->post->meta_keyword) }}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" name="meta_description"
                                    id="meta_description">{{ old('meta_description', @$menu->post->meta_description) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor {{ $errors->has('page_text') ? 'is-invalid' : '' }}" name="page_text"
                            id="page_text">{!! old('page_text', @$menu->post->page_text) !!}</textarea>
