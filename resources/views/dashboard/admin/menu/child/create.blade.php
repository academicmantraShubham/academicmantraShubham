...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }}  Child{{ trans('cruds.menu.title_singular') }} of {{ $menu->title }}
    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('ctitle') ? 'is-invalid' : '' }}" type="text" name="ctitle" id="title" value="{{ old('ctitle', '') }}" >
