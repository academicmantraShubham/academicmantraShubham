        ...
        <form method="POST" action="{{ route("admin.menu.update", [$menu->id]) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content" id="content" required>
                            {{-- <option hidden="" disabled="disabled" selected="selected" value="">Has Content</option> --}}
                            <option value="1" {{  old('content', $menu->content) == 1 ? 'selected' : '' }}>Yes</option>
                            <option value="0"  {{  old('content', $menu->content) == 0 ? 'selected' : '' }}>No</option>
                        </select>
            ...
            <div id="content_data" style="display: none">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="required" for="ctitle">Content {{ trans('cruds.contentPage.fields.title') }}</label>
                            <input class="form-control {{ $errors->has('ctitle') ? 'is-invalid' : '' }}" type="text" name="ctitle" id="ctitle" value="{{ old('ctitle', @$menu->post->title) }}" >
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title',  @$menu->post->meta_title) }}" >
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('meta_keyword') ? 'is-invalid' : '' }}" type="text" name="meta_keyword" id="meta_keyword" value="{{ old('meta_keyword',  @$menu->post->meta_keyword) }}" >
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('page_text') ? 'is-invalid' : '' }}" name="page_text" id="page_text">{!! old('page_text',  @$menu->post->page_text) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor{{ $errors->has('excerpt') ? 'is-invalid' : '' }}" name="excerpt" id="excerpt">{{ old('excerpt',  @$menu->post->excerpt) }}</textarea>
...
<script>
    ...
    init: function () {
    @if(isset($menu) && $menu->post && $menu->post->featured_image)
        var file = {!! json_encode($menu->post->featured_image) !!}
