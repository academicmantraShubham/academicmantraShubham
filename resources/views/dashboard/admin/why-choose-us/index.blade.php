                                    ...
                                    <form  method="POST" action="{{ route('admin.homepage.update', $homepage->id) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-12">
                                                ...
                                                <input class="form-control" type="text" id="alt" name="alt" placeholder="fa-user (only last code)" value="{{ old('alt',  $homepage->alt) }}">           
                                            </div>
                                        </div> 
                            ...
                            <div class="modal-body">
                               <form  method="POST" action="{{ route('admin.homepage.store') }}" enctype="multipart/form-data">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        <label for="title">Icon</label>
                                        <input class="form-control" type="text" id="alt" name="alt" placeholder="fa-user (only last code)" value="{{ old('alt') }}">           
                                    </div>
                                 </div> 
                                <button type="submit" class="btn btn-success btn-rounded btn-fw">Submit</button>     
                             </form> 
