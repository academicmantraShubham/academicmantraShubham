                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text"
                                name="slug" id="slug" value="{{ old('slug', $contentPage->slug) }}" required readonly>
                            @if ($errors->has('slug'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('slug') }}
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text"
                                ...
                                value="{{ old('meta_title', $contentPage->meta_title) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('meta_keyword') ? 'is-invalid' : '' }}"
                                type="text" name="meta_keyword" id="meta_keywords"
                                value="{{ old('meta_keyword', $contentPage->meta_keyword) }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" name="meta_description"
                                id="meta_description">{{ old('meta_description', $contentPage->meta_description) }}</textarea>
