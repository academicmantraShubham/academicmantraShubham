...
@section('headerData')
  ...
  <meta name="description" content="{{ $post->meta_description ?? 'Best essay writing services in Australia. We provide assignment, academic content, dissertation and thesis writing with zero plagiarism.' }}">
  <meta name="keywords" content="{{ $post->meta_keyword ?? 'Best essay writing in Australia, online assignment help, Academic writing services, thesis writing and dissertation writing services, online writing services' }}" >
@endsection
  ...
  <header class="ex-header">
    ...
    <div class="ex-basic-1 pt-5 pb-5">
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-fluid mt-5 mb-3" src="{{ $post->featured_image->getUrl() }}" alt="{!! $post->alt !!}">
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
