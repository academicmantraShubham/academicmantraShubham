            ...
            <div class="col-lg-6  mt-lg-0 mt-5  cwp23-text">
              ...
              <div class="row justify-content-center">
                <div class="col-md-5 testimonial-card p-2 m-2">
                  ...
                  <p>Our writers have the highest ratings, great testimonials, and many years of experience writing.</p>
                </div>
                <div class="col-md-5 testimonial-card p-2 m-2">
                  ...
                  <p>We offer highly valuable and specialised trending courses for students who want to succeed in their field.</p>
                </div>
                <div class="col-md-5 testimonial-card p-2 m-2">
                  ...
                  <form action="" method="post" class="" enctype="multipart/form-data">
                    ...
                    <div class="main-input">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group py-2">
                            <input type="text"  class="form-control form-control-input" placeholder="Choose Deadline"  onfocus="(this.type='date')" name="deadline"    min="<?php echo date('Y-m-d'); ?>" required/>
                          </div>
                        </div>
                      </div>
                      <div class="form-group py-2">
